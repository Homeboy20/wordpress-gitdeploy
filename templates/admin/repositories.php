...
<div class="github-deployer-repositories">
    ...
    if (isset($_GET['status_refreshed']) && $_GET['status_refreshed'] === '1') {
        echo '<div class="github-deployer-notice github-deployer-notice-success is-dismissible"><p>';
    ...
    <div class="github-deployer-sections">
                ...
                <div class="github-deployer-search-form">
                    <div class="search-form-row">
                        ...
                        <div class="search-form-actions">
                            <button type="button" id="github-deployer-fetch-repos" class="github-deployer-button github-deployer-button-primary"><?php esc_html_e('Fetch Repositories', 'github-deployer'); ?></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="github-deployer-card">
            <div class="github-deployer-card-header">
                <div class="section-header" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="refresh-status-form">
                        ...
                        <button type="submit" class="github-deployer-button github-deployer-button-secondary"><?php esc_html_e('Refresh All Status', 'github-deployer'); ?></button>
                    </form>
                </div>
            </div>
            ...
            <div class="github-deployer-card-body">
                ...
                <?php else: ?>
                    <div class="github-deployer-table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="connection-status">
                                            <?php if (isset($repo['connected']) && $repo['connected']): ?>
                                                <span class="github-deployer-status github-deployer-status-connected"><span class="dashicons dashicons-yes-alt"></span> <?php esc_html_e('Connected', 'github-deployer'); ?></span>
                                            <?php else: ?>
                                                <span class="github-deployer-status github-deployer-status-disconnected"><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Disconnected', 'github-deployer'); ?></span>
                                        ...
                                        <td class="auto-update-status">
                                            <?php if (isset($repo['is_tracked']) && $repo['is_tracked']): ?>
                                                <span class="github-deployer-status github-deployer-status-enabled"><span class="dashicons dashicons-yes"></span> <?php esc_html_e('Enabled', 'github-deployer'); ?></span>
                                            <?php else: ?>
                                                <span class="github-deployer-status github-deployer-status-disabled"><span class="dashicons dashicons-no"></span> <?php esc_html_e('Disabled', 'github-deployer'); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php 
                                            ...
                                            <div class="action-buttons" style="display: flex; flex-wrap: wrap; gap: 5px;">
                                                <?php if (isset($repo['connected']) && $repo['connected']): ?>
                                                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="disconnect-form">
                                                        ...
                                                        <button type="submit" class="github-deployer-button github-deployer-button-danger"><?php esc_html_e('Disconnect', 'github-deployer'); ?></button>
                                                    </form>
                                                <?php else: ?>
                                                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="connect-form">
                                                        ...
                                                        <button type="submit" class="github-deployer-button github-deployer-button-primary"><?php esc_html_e('Connect', 'github-deployer'); ?></button>
                                                    </form>
                                                <?php endif; ?>
                                                ...
                                                <?php if (isset($repo['is_tracked']) && $repo['is_tracked']): ?>
                                                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="disable-tracking-form">
                                                        ...
                                                        <button type="submit" class="github-deployer-button github-deployer-button-secondary"><?php esc_html_e('Disable Auto-Update', 'github-deployer'); ?></button>
                                                    </form>
                                                <?php else: ?>
                                                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="enable-tracking-form">
                                                        ...
                                                        <button type="submit" class="github-deployer-button github-deployer-button-success"><?php esc_html_e('Enable Auto-Update', 'github-deployer'); ?></button>
                                                    </form>
                                                <?php endif; ?>
                                                ...
                                                <a href="<?php echo esc_url(add_query_arg(array(
                                                    ...
                                                    'type' => $repo['type'],
                                                    'update' => '1'
                                                ), admin_url('admin.php'))); ?>" class="github-deployer-button github-deployer-button-primary"><?php esc_html_e('Update', 'github-deployer'); ?></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
...
<script type="text/template" id="github-deployer-repo-template">
    <div class="github-deployer-repo-item">
        <div class="github-deployer-repo-header">
            <h3><a href="{repoUrl}" target="_blank">{fullName}</a></h3>
        </div>
        <div class="github-deployer-repo-body">
            <p class="description">{description}</p>
            <div class="github-deployer-repo-meta">
        ...
        <div class="github-deployer-repo-footer">
            <a href="{deployUrl}" class="github-deployer-button github-deployer-button-primary">Deploy</a>
        </div>
    </div>
</script> 